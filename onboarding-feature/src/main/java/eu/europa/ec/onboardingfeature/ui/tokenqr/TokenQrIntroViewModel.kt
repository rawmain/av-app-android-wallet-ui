...
import eu.europa.ec.commonfeature.config.IssuanceFlowType.NoDocument
import eu.europa.ec.commonfeature.config.QrScanFlow.Issuance
...
sealed class Event : ViewEvent {
    ...
    data object OnScanClicked : Event()
}
                                ...
                                mapOf(
                                    QrScanUiConfig.serializedKeyName to uiSerializer.toBase64(
                                        QrScanUiConfig(
                                            ...
                                            qrScanFlow = Issuance(NoDocument),
                                        ),
